# -*- coding: utf-8 -*-
"""KS_GPU(JumpSearch+Shared).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1kcfrPJPzTst-lqWrh-sjn_9JGONqg_f8
"""
...
#Import Shocks
# idshock = np.genfromtxt("/scratch/alpine/alpe9373/CCE-GPU/input/idshock.csv",dtype=np.uint8,delimiter=',') # original path
idshock = np.genfromtxt(r"input/idshock.csv",dtype=np.uint8,delimiter=',')
idshock = idshock - 1
# agshock = np.genfromtxt("/scratch/alpine/alpe9373/CCE-GPU/input/agshock.csv",dtype=np.uint8,delimiter=',') # original path
agshock = np.genfromtxt(r"input/agshock.csv",dtype=np.uint8,delimiter=',')
agshock = agshock - 1
