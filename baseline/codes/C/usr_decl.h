...
const int NSTATES = 1600; //NSTATES_ID*NSTATES_AG*NKGRID*NKM_GRID
...
//
#if USE_FLOAT
const REAL TOLL_K = 1e-3; // convergence criterion for the individual capital function
const REAL TOLL_COEFF=1e-3; // convergence criterion for the coefficients B in the ALM
#else
