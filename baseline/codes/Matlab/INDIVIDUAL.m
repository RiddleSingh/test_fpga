...
function [kprime,c,niter,timetot]  = INDIVIDUAL(interp_type, prob,ur_b,ur_g,ngridk,ngridkm,nstates_ag,nstates_id,k,km,er_b,er_g,a,epsilon,l_bar,alpha,delta,gamma,beta,mu,km_max,km_min,kprime,B,criter_k,k_min,k_max,update_k);
%
...
dif_k=1;
   ...
   % Bad aggregate state and unemployed idiosyncratic state 
     ...
     k2prime_bu=interpn(k,km,kprime(:,:,1,1),kprime,kmprime,interp_type); 
   ...
   % Bad aggregate state and employed idiosyncratic state
     ...
     k2prime_be=interpn(k,km,kprime(:,:,1,2),kprime,kmprime,interp_type);
   ...
   % Good aggregate state and unemployed idiosyncratic state
     ...
     k2prime_gu=interpn(k,km,kprime(:,:,2,1),kprime,kmprime,interp_type);
   ...
   % Good aggregate state and employed idiosyncratic state
     ...
     k2prime_ge=interpn(k,km,kprime(:,:,2,2),kprime,kmprime,interp_type);
